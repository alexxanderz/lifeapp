...
var LifeCanvas = function () {
    function LifeCanvas() {
        _classCallCheck(this, LifeCanvas);
    ...
    _createClass(LifeCanvas, [{
        key: 'ensureContext',
        value: function ensureContext() {
            if (this.context == null) this.loadContext();
        }
    }, {
        key: 'loadContext',
        ...
        value: function drawCellAt(x, y) {
            ...
            this.context.fillRect(x * this.cellWidth - this.originX * this.cellWidth, y * this.cellHeight - this.originY * this.cellHeight, this.cellWidth, this.cellHeight);
        }
    }, {
        key: 'moveOrigin',
...
var App = function () {
    ...
    _createClass(App, null, [{
        ...
        value: function init() {
            ...
            chan.on("update:cells", function (msg) {
